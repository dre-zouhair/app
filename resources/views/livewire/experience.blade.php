        ...
        <div class="grid grid-rows-1">
            <div class="flex flex-wrap -mx-2 space-y-4 md:space-y-0">
                <div class="w-full px-2 md:w-1/5">
                    <x-jet-input class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" placeholder="Enter the enterprse" type="text" wire:model="enterprise"/>
        ...
        <div>
            @foreach($experiences as $key => $value)
                <div class="flex flex-wrap -mx-2 space-y-4 md:space-y-0 m-2">
                    <div class="w-full px-2 md:w-1/5">
                        <x-jet-input class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" value="{{$value->enterprise}}" />
                    </div>
                    <div class="w-full px-2 md:w-1/5">
                        <x-jet-input class="w-full h-10 px-3 text-base placeholder-gray-600 border rounded-lg focus:shadow-outline" type="text" value="{{$value->desc}}" />
                    </div>
                    <div class="w-full px-2 md:w-1/5">
