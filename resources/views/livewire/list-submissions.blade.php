        ...
        @if($display)
            <div class=" bg-white bg-white shadow-lg mx-2 p-4 col-span-2 border-b border-gray-200">
                ...
                <div class="text-center">
                    ...
                    <button class="bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-white py-2 px-4 border border-red-500 hover:border-transparent m-2 w-4/12" wire:click.prevent="reject()">
                        Reject </button>
                </div>
